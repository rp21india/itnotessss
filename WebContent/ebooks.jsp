...
<div class="col-md-5">
	...
	<div class="row" >
		<div style="padding: 10px; text-align: left;" class="col-md-12">
			...
			<div class="col-md-6">
							<select name="university" id="university" class="form-control" onchange="courseebook(this.value)">
	    ...
	    <div style="padding: 10px; text-align: left; class="col-md-12">
			...
			<div id='ebookdiv' class="col-md-12" style="margin:30px; margin-left:5px;">  
