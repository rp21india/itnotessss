            ...
            <div style="float: left; width: 100%; margin-top: 10px; margin-bottom: 0px; vertical-align: top;" class="col-md-12">
                <div style="float: left; height: 600px;">
                    <form action="/itnotes/UserServlet" method="post" name="form" onsubmit="" role="form">
                        <input type="hidden" name="type" id="type" value="Feedback Query"  class="form-control">
                        <div style="float: left ; width: 100%;">
                            <div style="text-align: left;" class="col-md-12">
                                <div class="form-group">
                                    <label for="name">Current Password</label>
                                    <input type="password" name="cpassword" id="cpassword" required class="form-control" placeholder="Current Password">
                                </div>
                                <div class="form-group">
                                    <label for="name">New Password</label>
                                    <input type="password" name="npassword" id="npassword" required class="form-control" placeholder="New Password">
                                </div>
                                                                 <div class="form-group">
                                    <label for="name">Confirm Password</label>
                                    <input type="password" name="upassword" id="upassword" required class="form-control" placeholder="Conform Password">
                                </div>
                              
                                <div class="form-group">
                                    <input type="submit" class="btn btn-lg btn-primary" name="updatepassword"value="Update" style="margin-right: 20px;/> <!--style="height: 30px; width: 120px; font-family: Calibri, Trebuchet MS , Arial; font-size: 15pt; margin-right: 30px;"-->
                                    <input type="reset"  class="btn btn-lg btn-primary" value="Reset" /><!--style="height: 30px; width: 120px; font-family: Calibri, Trebuchet MS , Arial; font-size: 15pt; margin-right: 95px;"--> 
                                </div>
                            </div> 
                        </div>
                    </form>
