...
%>
<%
  String ebookid = request.getParameter("eid");     
  String query = "select filename, content from ebook where ebook_id = " + ebookid;
  ...
  output.write(bdata);
  String ebookquery="select ebooks from downloads";
  ResultSet r = MyConnection.getResultFromSqlQuery(ebookquery);
  r.next();
  ebook=r.getInt("ebooks");
  ...
  int i=mi.updateebooks(stmt, ebook);
