...
<%!int syllabus; %>
<%
  String syllabusid = request.getParameter("sid");     
  String query = "select filename, content from syllabus where sid = " + syllabusid;
  ...
  output.write(bdata);
  String syllquery="select syllabus from downloads";
  ResultSet r = MyConnection.getResultFromSqlQuery(syllquery);
  r.next();
  syllabus=r.getInt("syllabus");
  ...
  Statement stmt=con.createStatement();
	...
	int i=mi.updatesyllabus(stmt, syllabus);
%>
</body>
</html>