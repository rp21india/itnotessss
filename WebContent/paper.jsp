...
<div class="col-md-5">
	...
	<div class="row" >
		<div style="padding: 10px; text-align: left;" class="col-md-12">
			...
			<div class="col-md-6">
				<select name="university" id="university" class="form-control" onchange="papercourse(this.value)">
		...
		<div style="padding: 10px; text-align: left; background-color: #f0f0f0;" class="col-md-12">
			...
			<div class="col-md-6" id="fillcourse">
        ...
        <div style="padding: 10px; text-align: left; class="col-md-12">
			<div class="col-md-3" >Year/Sem</div>
			<div class="col-md-6" id="fillyear">
				<select name="yearsem" id="yearsem"  class="form-control" onchange="">
		...
		<div style="padding: 10px; text-align: left; background-color: #f0f0f0;" class="col-md-12">
			...
			<div class="col-md-6" id="fillsubject">
				<select name="ctype" id="ctype"  class="form-control" onchange="">
            ...
            <div id='paperdiv' class="col-md-12" style="margin:30px; margin-left:5px;">  
</div>
		</div>
	</div>
</div>
