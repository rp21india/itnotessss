...
<div class="col-md-9"> 
        ...
        <div class="row">
            <div class="col-md-11" style="background-color: #EBEBEB; border-bottom : solid 4px #A3A3A3; margin: 0px 0px 10px 0px;">
        ...
        <div class="row">
            <div style="float: left; width: 100%; margin-top: 10px; margin-bottom: 0px; vertical-align: top;" class="col-md-12">
                <div style="float: left; height: 600px;">
                    <form action="/itnotes/UserServlet" method="post" name="feedback" onsubmit="" role="form">
                        <input type="hidden" name="type" id="type" value="Feedback"  class="form-control">
                        <div style="float: left ; width: 100%;">
                            <div style="text-align: left;" class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mobile" id="mobile" required class="form-control" placeholder="Enter Mobile" maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                                </div>
                                <div class="form-group">
                                    <label for="category">Category</label>
                                    <select name="category" class="form-control" required>
                                        <option name="Notes" value="Notes">Notes</option>
                                        <option name="Papers" value="papers">Papers</option>
                                        <option name="Ebooks" value="Ebooks">Ebooks</option>
                                        <option name="Syllabus" value="Syllabus" >Syllabus</option>
                                        <option name="Program" value="Program">Assignment Programs</option>
                                        <option name="PPT" value="PPT">PPT</option>
                                        <option name="Project Topic" value="Project Topic">Project Topic List </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="feedback" id="feedback" cols="52" rows="5" required class="form-control" placeholder="Type some char"></textarea>

                                </div>
                                    <div class="form-group">
                                    <input type="submit" value="Submit"  name="feedback" class="btn btn-lg btn-primary"style=" margin-right: 20px;" />
