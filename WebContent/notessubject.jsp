...
<div class="form-group">
                   ...
                   <div class="col-md-12">
				<select name="subject" id="subject" class="form-control" onchange="fillnotes('<%=request.getParameter("uid")%>','<%=request.getParameter("cid") %>','<%=request.getParameter("yid") %>', this.value)">
