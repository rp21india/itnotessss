...
<div class="col-md-5">
	...
	<div class="row" >
		<div style="padding: 10px; text-align: left;" class="col-md-12">
			...
			<div class="col-md-6">
				<select name="university" id="university" class="form-control" onchange="coursenotes(this.value)">
		...
		<div style="padding: 10px; text-align: left; background-color: #f0f0f0;" class="col-md-12">
            ...
            <div id='notesdiv' class="col-md-12" style="margin:30px; margin-left:5px;">  
</div>
		</div>
	</div>
</div>
