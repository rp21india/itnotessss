...
<script type="text/javascript">
	...
	{
		document.frmsyllabus.method="post";
		document.frmsyllabus.action="delMulSyllabus.jsp";
		document.frmsyllabus.submit();
	}
</script>
		...
		<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">University Syllabus</h1>
                    <button class="btn btn-sm btn-primary pull-right" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModalHorizontal">Add Syllabus</button>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" enctype="multipart/form-data" action="uploadsyllabus.jsp" method="post">
			...
			%>  
				...
				<select name="ctype" id="ctype"  class="form-control" onchange="">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label"
                          for="syllabus" >File</label>
                    <div class="col-sm-10">
                        <input type="file" class="form-control"
                            id="syllabus" name="syllabus" accept=".txt,
           application/pdf,
           ...
           application/msword"/>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" class="btn btn-primary" name="uploadsyllabus" value="Upload Syllabus"/>
                    </div>
                  </div>
                </form>
                 ...
                 <%! int sid,uid,cid;
					String filename,type,course,university;
                %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Syllabus for all university in Rajasthan
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                          <form name="frmsyllabus">
            ...
            ResultSet rs= mi.selectSyllabus(stmt);
            while(rs.next())
			{
            	sid=rs.getInt("sid");
            	//uid=rs.getInt("uid");
				...
				%>
                                <tbody>
                                    <tr class="odd gradeX">
                                        <td><input type="checkbox" name="chkdeletesid" value="<%=rs.getInt("sid") %>"/></td>
                                        <td><%=sid %></td>
                                        <td><%=university %></td>
                                        <td><%=course%></td>
                                        <td><%=filename %></td>
				...
				<td><a href="viewSyllabus.jsp?syllabusid=<%=sid %>">View</a></td>
				<td><a href="/itnotes/deleteServlet?syllabusid=<%=sid %>" onclick="if(confirm('Are you sure to delete this record')){return true;}else{return false;}">delete</a></td>                   </tr>
                                   <% 
			}
