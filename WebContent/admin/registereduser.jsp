...
<script type="text/javascript">
	function deleteSelected()
	{
		...
		document.frmuser.action="delMulUser.jsp";
...
<div class="modal fade" id="myModalHorizontal" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form class="form-horizontal"  action="../myservlet" method="post">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" class="btn btn-primary" name="reguser" value="Search"/>
                    </div>
                  </div>
                </form>
            ...
            <%! int userid;
		String uname,gender,dob,city,email;
	%>
            ...
            ResultSet rs= mi.selectUser(stmt);
            while(rs.next())
			{
				...
				%>
                                <tbody>
                                    <tr class="odd gradeX">
                                        <td><input type="checkbox" name="chkdeleteuserid" value="<%=rs.getInt("user_id") %>"/></td>
                                        <td><%=userid %></td>
                                        <td><%=uname %></td>
                                        <td><%=gender %></td>
                                        <td><%=dob %></td>
				...
				<td><a href="/itnotes/deleteServlet?userid=<%=userid %>" onclick="if(confirm('Are you sure to delete this record')){return true;}else{return false;}">delete</a></td>
                                    </tr>
                                   <% 
			}
