...
<script type="text/javascript">
	...
	{
		document.frmppt.method="post";
		document.frmppt.action="delMulPpt.jsp";
		document.frmppt.submit();
	}
</script>
		...
		<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button class="btn btn-sm btn-primary pull-right" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModalHorizontalprogram">Add PPT</button>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="modal-body">
             ...
             <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" class="btn btn-primary" name="addppttechnology" value="Add Technology"/>
                    </div>
                  </div>
                </form>                
    ...
    <div class="modal-dialog">
        <div class="modal-content">
				...
				<select name="technology" id="technology" class="form-control" onchange="">
				 ...
				 <%
                   ...
                   Connection con=(Connection)MyConnection.getConnection();
                          			...
                          			String query="select * from ptechnology";
			...
			%>  
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" class="btn btn-primary" name="addppttopics" value="Add Topics"/>
                    </div>
                  </div>
                </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" enctype="multipart/form-data" action="uploadppt.jsp" method="post">
                  <div class="form-group">
                    <label  class="col-sm-2 control-label"
                              for="technology">Technology</label>
                   <div class="col-md-10">
				<select name="technology" id="technology" class="form-control" onchange="fillppttopics(this.value)">
			...
			%>  
                   ...
                   <div class="form-group">
                    <label class="col-sm-2 control-label"
                          for="course" >Topics</label>
                    <div class="col-md-10" id="fillppttopics">
				<select name="topics" id="topics"  class="form-control" onchange="">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <input type="submit" class="btn btn-primary" name="addppt" value="Add PPT"/>
                    </div>
                  </div>
                </form>
                 ...
                 <%! int pptid;
					String technology,topic,filename;
                %>
            ...
            ResultSet rs= mi.selectPpt(stmt);
            while(rs.next())
			{
            	pptid=rs.getInt("ppt_id");
            	
				technology=rs.getString("ptechnology");
				topic=rs.getString("ptopics");
				...
				%>
                                <tbody>
                                    <tr class="odd gradeX">
                                        <td><input type="checkbox" name="chkdeletepptid" value="<%=rs.getInt("ppt_id") %>"/></td>
                                        <td><%=pptid %></td>
                                        <td><%=technology %></td>
                                        <td><%=topic%></td>
                                        <td><%=filename %></td>
				...
				<td><a href="viewPpt.jsp?pptid=<%=pptid %>">View</a></td>
				<td><a href="/itnotes/deleteServlet?pptid=<%=pptid %>" onclick="if(confirm('Are you sure to delete this record')){return true;}else{return false;}">delete</a></td>                   </tr>
                                   <% 
			}
